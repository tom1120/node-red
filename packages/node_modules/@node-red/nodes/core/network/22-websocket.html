...
<script type="text/javascript">
    /*global RED*/
    RED.nodes.registerType('websocket-instance', {
        category: 'network',
        inputs: 0,
        outputs: 0,
        color: "#ffffff",
        // icon: "redis.png",
        paletteLabel: "ws-instance",
        defaults: {
            server: {
                value: "",
...
<script type="text/x-red" data-template-name="websocket-instance">
    <div class="form-row">
...
<script type="text/x-red" data-help-name="websocket-instance">
    <p>Websocket Instance</p>
    <p>Injects a Websocket connection on flow or global context.</p> 
    <p>The Topic is the var name of websocket.</p>
    <p></p>
</script>